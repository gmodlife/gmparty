...
if ( CLIENT ) then
	...
	surface.CreateFont('CSKillIcons', {size=ScreenScale( 30 ), weight=500, antialias=true, font="csd"});
	surface.CreateFont('CSSelectIcons', {size=ScreenScale( 60 ), weight=500, antialias=true, font="csd"});
...
---------------------------------------------------------*/
function SWEP:CSShootBullet( dmg, recoil, numbul, cone, fake )
