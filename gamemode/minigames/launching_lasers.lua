MINIGAME.ID = 13; // Make sure this is a unique identifier. Used to synch client and server.
MINIGAME.Name = "Launching Lasers"; // Used for display purposes only.
MINIGAME.Description = "Use your laser gun to kill your opponents"; // The font used makes this all capped. No punctuation, please
