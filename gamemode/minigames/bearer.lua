MINIGAME.ID = 16; // Make sure this is a unique identifier. Used to synch client and server.
MINIGAME.Name = "Sluggish Bearer"; // Used for display purposes only.
MINIGAME.Description = "Throw grenades at your enemies and survive your enemies grenades."; // The font used makes this all capped. No punctuation, please
...
MINIGAME.PlayerDamageScale = 0.5; // How much damage should the player take? 1 is normal / default.
...
Player:GiveAmmo(500,"grenade");
Player:SetWalkSpeed(95)
Player:SetRunSpeed(95)
