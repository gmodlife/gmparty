...
MINIGAME.Name = "Free For All"; // Used for display purposes only.
MINIGAME.Description = "Use your Guns to kill your enemies"; // The font used makes this all capped. No punctuation, please
