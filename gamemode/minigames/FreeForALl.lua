MINIGAME.ID = 9; // Make sure this is a unique identifier. Used to synch client and server.
MINIGAME.Name = "Backfiring Berettas"; // Used for display purposes only.
MINIGAME.Description = "Use your faulty handgun to kill your enemies"; // The font used makes this all capped. No punctuation, please
...
function MINIGAME.PlayerLoadout ( Player )
	--Player:Give('weapon_gmp_fiveseven');
	Player:Give('weapon_smg1');
	Player:Give('weapon_crowbar');
	Player:GiveAmmo(200,'smg1')
